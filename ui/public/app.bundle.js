...
var IssueEdit = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(IssueEdit, [{
    ...
    value: function render() {
      ...
      if (id == null) {
        if (propsId != null) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Isssue with ID ".concat(propsId, " not found."));
        }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 11;
                return Object(_graphQLFetch_js__WEBPACK_IMPORTED_MODULE_4__["default"])(query, vars, this.showError);
